...
export default function Navbar() {
  ...
  /* Always start transparent/dark — turn cream only after user scrolls */
...
function DropdownLink({item,light}){
  ...
  return(
    <div style={{position:"relative"}} onMouseEnter={enter} onMouseLeave={leave}>
      <button style={{display:"flex",alignItems:"center",gap:4,padding:"8px 16px",paddingBottom:6,background:"none",border:"none",borderBottom: isActive ? `2px solid ${light?"rgba(255,255,255,0.7)":"#1A50A0"}` : "2px solid transparent",cursor:"pointer",fontFamily:"'Inter',sans-serif",fontSize:13,fontWeight: isActive ? 600 : 500,color:open||isActive?(light?"#FFFFFF":"#1A50A0"):(light?"rgba(255,255,255,0.85)":"rgba(13,21,32,0.5)"),transition:"color 0.2s"}}>
        {item.label}
