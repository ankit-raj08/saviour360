...
const toFaq = (doc) => ({ q: doc.question, a: doc.answer });
const FAQS_ENDPOINT = "/api/faqs?where[active][equals]=true&sort=order&limit=30";

export default function FAQSection() {
  const { data: FAQS } = useCMS(FAQS_ENDPOINT, FALLBACK_FAQS, toFaq);
  const [open, setOpen] = useState(0);

  return (
    <section id="faq" style={{ background: "#FFFFFF", padding: "72px 0" }}>
