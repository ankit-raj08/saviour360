export const NAV_ITEMS = [
  {
    label: "Services",
    dropdown: [
      { label: "360° Interior Views",  desc: "Full property walkthrough, every room",         href: "/services#interior" },
      { label: "Aerial / Drone Views", desc: "Bird's-eye views of site & surroundings",       href: "/services#aerial" },
      { label: "Google Street Views",  desc: "Publish directly to Google Maps",               href: "/services#google" },
    ],
  },
  {
    label: "Industries",
...
export const FOOTER_LINKS = [
  {
    section: "Services",
    links: [
      { label: "360° Interior Views", href: "/services#interior" },
      { label: "Aerial / Drone Views", href: "/services#aerial" },
      { label: "Google Street Views",  href: "/services#google" },
    ],
  },
  {
    section: "Industries",
